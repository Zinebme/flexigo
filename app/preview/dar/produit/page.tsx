...
export default function DarProductPreview(){
 return <div dir="rtl" className="dar-root min-h-screen" style={darCssVars()}>
  ...
  <DarContainer className="py-6"><a href="/preview/dar" className="text-xs font-bold text-[var(--dar-muted)]">← العودة إلى DAR</a><div className="mt-5"><DarProductView data={{
   storeSlug:"dar-demo",base:"/preview/dar",copy:souqCopy("ar"),lang:"ar",currency:"DZD",settings:SOUQ_CHECKOUT_DEFAULTS,
   product:{id:"d1000000-0000-4000-8000-000000000000",slug:"organizer",name:"منظم منزلي متعدد الاستعمال",priceCents:290000,compareAtPriceCents:340000,imageUrl:"/images/dar/storage.svg",stock:20,ratingAverage:4.8,ratingCount:96},
   ...
   images:["/images/dar/storage.svg","/images/dar/banner.svg"],description:"منظم عملي متعدد الاستعمال مناسب للمطبخ، الحمام أو غرفة التخزين. تصميم بسيط وألوان دافئة مع خيارات حجم ولون.",ratingAverage:4.8,ratingCount:96,
