...
export function pulseHomeSections(businessName:string):Section[]{return[
 s("hero",{badge:"تحرّك أكثر. استعد أقوى.",title:"معدات رياضية لحركة بلا حدود",subtitle:"رياضة، لياقة، ركض وتمارين منزلية — اختيارات عملية مع الدفع عند الاستلام.",desktop_image:"/images/pulse/hero.svg",mobile_image:"/images/pulse/hero-mobile.svg",button_text:"ابدأ التسوق",button_link:"/boutique",alignment:"right"}),
 ...
 s("banner",{title:"ابنِ روتينك. ارفع مستواك.",subtitle:"منتجات تساعدك على التدريب بانتظام من البيت أو الجيم.",desktop_image:"/images/pulse/banner.svg",mobile_image:"/images/pulse/banner-mobile.svg",button_text:"اكتشف المجموعة",button_link:"/boutique",alignment:"right",show_desktop:true,show_mobile:true}),
...
export function pulseContentPages(businessName:string){return[
 {key:"about",title:"من نحن",content:{sections:[s("hero",{title:businessName,subtitle:"متجر رياضي عربي عملي وسريع.",image:"/images/pulse/banner.svg",button_text:"تسوّق الآن",button_link:"/boutique",alignment:"right"})]}},
