...
export function littleHomeSections(businessName:string):Section[]{return[
 s("hero",{badge:"عالم صغير مليء بالفرح",title:"كل ما يحتاجه طفلك… بحب",subtitle:"ملابس، ألعاب، عناية، نوم وهدايا — تجربة شراء عربية لطيفة وسهلة مع الدفع عند الاستلام.",desktop_image:"/images/little/hero-premium.webp",mobile_image:"/images/little/hero-premium.webp",button_text:"اكتشفي المجموعة",button_link:"/boutique",alignment:"right"}),
 ...
 s("banner",{title:"هدايا تخلّي اللحظة أجمل",subtitle:"اختيارات لطيفة للميلاد، السبوع وأعياد الميلاد.",desktop_image:"/images/little/hero-premium.webp",mobile_image:"/images/little/hero-premium.webp",button_text:"شاهدي الهدايا",button_link:"/boutique",alignment:"right",show_desktop:true,show_mobile:true}),
...
export function littleContentPages(businessName:string){return[
 {key:"about",title:"من نحن",content:{sections:[s("hero",{title:businessName,subtitle:"متجر أطفال عربي لطيف، عملي وسهل الاستخدام.",image:"/images/little/hero-premium.webp",button_text:"تسوّقي الآن",button_link:"/boutique",alignment:"right"})]}},
