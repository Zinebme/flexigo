...
export function StudioProductDraftEditor({
  value,onChange,onRemove,onDuplicate,onUploadingChange,index,
}:{value:StudioProductDraft;onChange:(v:StudioProductDraft)=>void;onRemove:()=>void;onDuplicate:()=>void;onUploadingChange?:(uploading:boolean)=>void;index:number}) {
